...
## v0.3.34 USB Debug Safe Enumeration Notes
...
## v0.3.34 USB Debug Handler Footprint Note
...
## v0.3.34 Safe GET_REPORT Length Note
...
## v0.3.34 SMT2200 Load Percent Mapping
...
Firmware v0.3.34 adds report `0x08` to the SMT2200 poll list and parses it as load percent.
